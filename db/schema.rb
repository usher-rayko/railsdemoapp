...
ActiveRecord::Schema[7.0].define(version: 2023_07_02_181005) do
  ...
  create_table "tbl_alumni", primary_key: "alumni_id", id: { type: :integer, unsigned: true }, charset: "latin1", force: :cascade do |t|
    ...
    t.string "phone_2"
    t.string "address"
    t.text "cv_brief_profile", null: false
    t.datetime "created_at", precision: nil, default: -> { "CURRENT_TIMESTAMP" }
  end
  ...
  create_table "tbl_alumni_awards", primary_key: "alumni_special_skill_id", id: { type: :integer, unsigned: true }, charset: "latin1", force: :cascade do |t|
    t.integer "alumni_id", null: false, unsigned: true
  ...
  create_table "tbl_chats", primary_key: "chat_id", id: { type: :bigint, unsigned: true }, charset: "latin1", force: :cascade do |t|
    ...
    t.integer "reciepient", unsigned: true
    t.text "chat_message"
    t.integer "seen", limit: 2, default: 0
    t.datetime "deleted_at", precision: nil
    t.timestamp "created_at", default: -> { "CURRENT_TIMESTAMP" }
    t.bigint "replied_to", unsigned: true
    t.index ["reciepient"], name: "reciepient"
  ...
  add_foreign_key "tbl_alumni_programmes", "tbl_programmes", column: "programme_id", primary_key: "programme_id", name: "tbl_alumni_programmes_ibfk_2", on_update: :cascade
  ...
  add_foreign_key "tbl_chats", "tbl_alumni", column: "reciepient", primary_key: "alumni_id", name: "tbl_chats_ibfk_3", on_update: :cascade
  ...
  add_foreign_key "tbl_news_and_announcements", "tbl_alumni", column: "created_by", primary_key: "alumni_id", name: "tbl_news_and_announcements_ibfk_1", on_update: :cascade
  add_foreign_key "tbl_news_and_announcements", "tbl_alumni", column: "deleted_by", primary_key: "alumni_id", name: "tbl_news_and_announcements_ibfk_2", on_update: :cascade
